...
/*
#define BT_STOP_START	  pin_C0 //botao liga/desliga
#define BT_BOBINA		  pin_C1 //botao bobina
#define BT_FIADOR		  pin_C2 //botao fiador
#define BT_INC			  pin_C3 //botao incrementa
#define BT_DEC			  pin_C4 //botao decrementa
...
if(!input(BT_STOP_START))// Testa botao start/stop se pressionados
{
...
delay_ms(500);			
if(!input(BT_STOP_START))// Testa botao start/stop se presionado
{
...
if(BT_ESPIRAS & BT_FIADOR & BT_BOBINA)output_LOW(LED_BOTOES);// Desliga Led botoes
